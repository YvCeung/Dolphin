package com.zyg.dolphin.datasource.sharding.algorithm;

import com.zyg.dolphin.datasource.sharding.id.DistributeID;
 ...
 * @author zy
 */
public class DolphinKeyShardingAlgorithm implements ComplexKeysShardingAlgorithm<String>, HintShardingAlgorithm<String> {

    private static Logger logger = LoggerFactory.getLogger(DolphinKeyShardingAlgorithm.class);
