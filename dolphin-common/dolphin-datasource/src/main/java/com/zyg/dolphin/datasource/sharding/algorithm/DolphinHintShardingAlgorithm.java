 ...
 * @author zy
 */
public class DolphinHintShardingAlgorithm implements HintShardingAlgorithm<String> {
    private Properties props;

    private static final Logger LOG = LoggerFactory.getLogger(DolphinHintShardingAlgorithm.class);
